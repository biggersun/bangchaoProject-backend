...
const { srcDir, distDir, appHtmlPath, browserJsPath, browserHtmlPath, faviconPath } = require('./files.config');
...
module.exports = () => {
    ...
    const generateBrowser = new HtmlWebpackPlugin({
        inject: 'body',
        filename: 'browser.html',
        template: browserHtmlPath,
        chunks: ['browser']
    });
